...
namespace Sakuno.KanColle.Amatsukaze.Bootstrap
{
    class NugetPackageProvider : IPackageProvider
    {
        ...
        {
            var api = await GetJsonAsync($"https://api-v2v3search-0.nuget.org/query?q=HeavenlyWind&skip={page * PackagesPerPage}&take={PackagesPerPage}&prerelease=false&semVerLevel=2.0.0");
