...
namespace Sakuno.ING.Game.Models
{
    public readonly struct ClampedValue : IEquatable<ClampedValue>
    {
        ...
        public static ClampedValue operator +(ClampedValue clamped, int value) =>
            new ClampedValue(Math.Min(clamped.Max, clamped.Current + value), clamped.Max);
        public static ClampedValue operator -(ClampedValue clamped, int value) =>
            new ClampedValue(Math.Max(0, clamped.Current - value), clamped.Max);
        ...
        public static ClampedValue FromRemaining(int max, int remaining) =>
            new ClampedValue(max - remaining, max);
